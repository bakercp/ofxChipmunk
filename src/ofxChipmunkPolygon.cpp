...
Polygon::Polygon(cpSpace *space, std::vector<ofVec2f> &points, float radius, float mass){
...
void Polygon::setup(cpSpace *space, std::vector<ofVec2f> &points, float radius, float mass){
